#!/usr/bin/env python3
"""
Recupero codici sconto Just Eat da shopilo.it
Sursa: https://shopilo.it/negozi/justeat.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/justeat.it"
STORE_NAME = "Just Eat"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Just Eat da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-justeat)"
    }
    try:
